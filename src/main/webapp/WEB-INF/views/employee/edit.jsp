...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div id="page-inner">
            ...
            <!-- /. ROW  -->
            <hr />
            <form:form action="/employee/editEmployee" method="post" modelAttribute="employee">
                <input type="hidden" name="id" value="${employee.id}" />
                <div class="form-group">
                    <label for="firstName">Imię:</label>
                    <form:input type="text" path="firstName" id="firstName" class="form-control" style="width: 200px;" value="${employee.firstName}" />
                    <form:errors path="firstName" element="div" class="error-message" />
                </div>
                <div class="form-group">
                    <label for="lastName">Nazwisko:</label>
                    <form:input type="text" path="lastName" id="type" class="form-control" style="width: 200px;" value="${employee.lastName}" />
